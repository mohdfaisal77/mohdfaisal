...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description: 'A social media platform developed with Flutter, allowing users to create profiles, share posts, connect with friends, and engage through comments and likes.',
    ...
    },
    {
      ...
      description: 'A comprehensive fitness application built with Swift for iOS, tracking workouts, nutrition, and progress with intuitive visualizations and personalized recommendations.',
      technologies: ['Swift', 'CoreData', 'HealthKit', 'Charts'],
    ...
    },
    {
      ...
      description: 'A productivity app developed with Kotlin for Android, featuring task creation, reminders, categories, and synchronization across devices.',
      technologies: ['Kotlin', 'Room Database', 'WorkManager', 'MVVM'],
